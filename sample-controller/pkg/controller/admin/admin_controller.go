...
import (
	...
	adminv1 "github.com/qiangyang/sample-controller/pkg/apis/admin/v1"
...
func (r *ReconcileAdmin) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set Admin instance as the owner and controller
...
func newPodForCR(cr *adminv1.Admin) *corev1.Pod {
